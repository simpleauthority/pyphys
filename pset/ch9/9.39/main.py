...
volume_total = ((4/3) * pi * (R**3)) / 2
volume_mass_density = M / volume_total

# draw coordinates
line_x = cylinder(pos=vec(-2, 0, 0), axis=vec(4, 0, 0), radius=0.05)
line_y = cylinder(pos=vec(0, -2, 0), axis=vec(0, 4, 0), radius=0.05)
